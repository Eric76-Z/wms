...
import EmsMaintenanceCard from "@/components/content/cards/EmsMaintenanceCard";
import { Dialog, Toast } from "vant";
import {
  listEmsMaintenanceRecords,
  partupBladeItemData,
  ...
  setup() {
    ...
    const listcfg = reactive({
      ...
      onLoad: () => {
        ...
        listEmsMaintenanceRecords(queryParam)
          .then((res) => {
            console.log(res);
